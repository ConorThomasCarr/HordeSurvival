...
namespace Weapon.BaseWeapon.Gun.Shotgun
{
    public class Shotgun : Gun
    {
        ...
        private void OnInitializeConfigs()
        {
            var baseData = new WeaponGeneralConfig
                { Parent = transform.root.gameObject, MuzzleOne = transform.GetChild(0), MuzzleTwo = transform.GetChild(1) };
