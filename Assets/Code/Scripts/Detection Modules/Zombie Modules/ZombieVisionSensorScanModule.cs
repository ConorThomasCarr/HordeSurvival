...
public class ZombieVisionSensorScanModule : MonoBehaviour, ISensorScanModule
{
    ...
    public void Enable()
    {
        //Debug.Log("Vision Sensor Scan Module Enable: " + gameObject.name);
    ...
    public void Disable()
    {
        //Debug.Log("Vision Sensor Scan Module Disable: " + gameObject.name);
