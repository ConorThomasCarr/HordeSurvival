...
public class ZombieVisionSensorMemoryModule : ISensorMemoryModule
{
    public List<AIMemory> memories {get; set;}
        
    public GameObject[] characters {get; set;}

    public ZombieVisionSensorMemoryModule(int maxPlayers)
    {
    ...
    {
        int targets = sensorModule.Filter(characters, "Player");
