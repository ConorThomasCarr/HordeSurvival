...
public class ZombieVisionSensorTargetingModule : MonoBehaviour, ISensorTargetingModule
{
    ...
    public void Awake()
    {
        Memory = new ZombieVisionSensorMemoryModule(25);
