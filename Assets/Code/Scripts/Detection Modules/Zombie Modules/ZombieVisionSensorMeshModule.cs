...
public class ZombieVisionSensorMeshModule : MonoBehaviour, ISensorMeshModule
{
    ...
    public void Enable()
    {
        //Debug.Log("Vision Sensor Mesh Module Enable: " + gameObject.name);
    ...
    public void Disable()
    {
        //Debug.Log("Vision Sensor Mesh Module Disable: " + gameObject.name);
